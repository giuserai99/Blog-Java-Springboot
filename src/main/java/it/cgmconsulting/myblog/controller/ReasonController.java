...
public class ReasonController {
    ...
    //  serve esclusivamente per l'inserimento di una nuova reason
    ...
    // cancellazione logica di una reason, ovvero invalidare la reason settando una data di fine validità
